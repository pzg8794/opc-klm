...
namespace KStreams
{
    ...
    {
        #region Camera
        public static ImageSource Bitmap(this ColorFrame frame)
        {
        ...
        public static String cframe(this ColorFrame frame)
        {
            String file = "";
            var dframe = frame.ColorFrameSource.FrameDescription;
            file += dframe.BytesPerPixel + "\n";
            file += dframe.DiagonalFieldOfView + "\n";
            file += dframe.Height + "\n";
            file += dframe.HorizontalFieldOfView + "\n";
            file += dframe.LengthInPixels + "\n";
            file += dframe.VerticalFieldOfView + "\n";
            file += dframe.Width + "\n";

            return file;
        }

        public static ImageSource Bitmap(this DepthFrame frame)
        {
            int width = frame.FrameDescription.Width;
            int height = frame.FrameDescription.Height;
            PixelFormat format = PixelFormats.Bgr32;
        ...
        public static String dframe(this DepthFrame frame)
        {
            String file = "";
            var dframe = frame.DepthFrameSource.FrameDescription;
            file += dframe.BytesPerPixel + "\n";
            file += dframe.DiagonalFieldOfView + "\n";
            file += dframe.Height + "\n";
            file += dframe.HorizontalFieldOfView + "\n";
        ...
        public static ImageSource Bitmap(this InfraredFrame frame)
        {
            int width = frame.FrameDescription.Width;
            int height = frame.FrameDescription.Height;
            PixelFormat format = PixelFormats.Bgr32;
        ...
        public static String iframe(this InfraredFrame frame)
        {
            String file = "";
            var dframe = frame.InfraredFrameSource.FrameDescription;
            file += dframe.BytesPerPixel + "\n";
            file += dframe.DiagonalFieldOfView + "\n";
            file += dframe.Height + "\n";
            file += dframe.HorizontalFieldOfView + "\n";
        ...
        public static void DrawSkeleton(this Canvas canvas, Body body)
        {
            ...
            {
                if (i != 13 && i != 14 && i != 15 && i != 17 && i != 18 && i != 19 )
                {
        ...
        public static void DrawLine(this Canvas canvas, Joint first, Joint second)
        {
            ...
            //Console.WriteLine(first.JointType);
            //Console.WriteLine(first.Position.X);
            //Console.WriteLine(first.Position.Y);
            //Console.WriteLine(first.Position.Z);
